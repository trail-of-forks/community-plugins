...
|------------|--------|--------------|---------|----------|-------------|
|[ethersplay Ethereum Architecture Plugin](https://github.com/ekilmer/ethersplay)|[Trail of Bits](https://github.com/ekilmer)|2022-11-02|AGPL-3.0-only|architecture|A disassembler and lifter for the Ethereum architecture.|
