...
|------------|--------|--------------|---------|----------|-------------|
|[ManticoreUI](https://github.com/ekilmer/manticoreui)|[Trail of Bits](https://github.com/ekilmer)|2022-10-31|AGPL-3.0|helper, ui|Graphical user interface to interact with Manticore symbolic execution engine|
